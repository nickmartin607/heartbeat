...
host_urls = [
    ...
    url(r'^check/(?P<id>[0-9]+)$',      CheckHost,                              name='check'),
]
service_urls = [
    ...
    url(r'^check/(?P<id>[0-9]+)$',      CheckService,                           name='check'),
    url(r'^check/all',                  CheckServices,                          name='check-all'),
]
task_urls = [
...
inject_urls = [
    ...
    url(r'complete/(?P<id>[0-9]+)$',    CompleteInject,                         name='complete'),
]
